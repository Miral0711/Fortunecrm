...
const DEFAULT_SPARK: SparkPoint[] = [
  { v: 8200 }, { v: 9100 }, { v: 7800 }, { v: 11200 },
  { v: 10400 }, { v: 13500 }, { v: 12800 }, { v: 15200 },
]

const DEFAULT_BREAKDOWN: CommissionItem[] = [
    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">Earnings breakdown — {period}</p>
        </div>
        <button
          onClick={onDetails}
      ...
      <div className="px-4 pt-3 pb-1">
        <div className="flex items-end justify-between mb-3">
          <div>
            ...
            <span className="ml-2 text-xs text-green-600 bg-green-50 px-1.5 py-0.5 rounded-full font-medium">{change}</span>
          </div>
              ...
              <AreaChart data={sparkData}>
                <defs>
                  <linearGradient id="commGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%"  stopColor="#e07b39" stopOpacity={0.2} />
