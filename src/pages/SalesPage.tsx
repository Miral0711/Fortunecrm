...
const SALES: Sale[] = [
  {
    id: "1",
    status: "Reserved",
    client: "Shanaka Samadattha Wijesuriya",
    project: "Parkview On Central",
    ...
    affiliate: "–",
    affiliateComms: 0,
    subscriber: "Dean Arnold",
  },
  {
    id: "2",
    status: "Reserved",
    client: "Shanaka Samadattha Wijesuriya",
    project: "Vineyard Street",
    developer: "Aleysha Roberts",
    lot: "34A",
    commsIn: 33000,
    piabComms: 3300,
    affiliate: "–",
  ...
  },
  {
    ...
    client: "Toni-Robyn Percy",
    project: "Voltaire Estate",
    developer: "William Nash",
    lot: "26",
    commsIn: 33000,
    piabComms: 3300,
    affiliate: "–",
    affiliateComms: 0,
    subscriber: "Bernice Cooper",
  },
  {
    id: "4",
    status: "Under Contract",
    client: "Tony Raymond Lawless",
    project: "Silkwood Enclave",
    developer: "David Armitage",
    lot: "21",
    commsIn: 38500,
    piabComms: 3850,
    affiliate: "–",
    affiliateComms: 0,
    subscriber: "Chris Wood",
  },
  {
    id: "5",
    status: "Under Contract",
    client: "Hendrik Stephanus Bosshoff",
    project: "Arbourwood Estate",
    developer: "Will Carnavas",
    lot: "352",
    commsIn: 33000,
    piabComms: 3300,
    affiliate: "–",
    affiliateComms: 0,
    subscriber: "Fred Thomasian",
  },
  {
    id: "6",
    status: "Unconditional",
    client: "Jobandeep Singh",
    project: "The Nursery Estate",
    developer: "David Armitage",
    lot: "53",
    commsIn: 38500,
    piabComms: 3850,
    affiliate: "–",
    affiliateComms: 0,
    subscriber: "Sukhbir Sodhi",
  },
  {
    id: "7",
    status: "Settled",
    client: "Vibha Jaypalsinh Bhati",
    project: "Irving Domain",
    developer: "Matt Low",
    lot: "107",
    commsIn: 21340,
    piabComms: 3300,
    affiliate: "–",
    affiliateComms: 0,
    subscriber: "Jagadesh Kandaswamy",
  },
  {
    id: "8",
    status: "Unconditional",
    client: "Mark Anthony Dearley",
    project: "Rooming – Harlowe Estate w/ 5-Year Rent Guarantee",
    developer: "Nic Carmody",
    lot: "804",
    commsIn: 33000,
    piabComms: 6600,
    affiliate: "–",
    affiliateComms: 0,
    subscriber: "Peter Desbrowe-Annear",
  },
  {
    id: "9",
    status: "Under Contract",
    client: "Sivakumar Sadhasivam",
    project: "Co-Living Aberdeen Estate w/ 5-Year Rental Guarantee",
    developer: "William Nash",
    lot: "39",
    commsIn: 33000,
    piabComms: 3300,
  ...
  },
  {
    id: "10",
    status: "Under Contract",
    client: "Deborah Smith",
    project: "Goranya Estate",
    developer: "Nick Hagilassis",
    lot: "7",
    commsIn: 33000,
    piabComms: 3300,
    affiliate: "–",
    affiliateComms: 0,
    subscriber: "Jean De La Croix",
  },
  {
    id: "11",
    status: "Reserved",
    client: "Amelia Johnson",
    project: "Harlow Estate",
    developer: "David Armitage",
    lot: "12",
    commsIn: 35000,
    piabComms: 3500,
    ...
    <PageWrapper>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow px-5 py-4">
        <div className="grid grid-cols-3 gap-x-6 gap-y-4">
          ...
          {/* Show Crashed toggle */}
          <div className="flex flex-col gap-1">
            <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider invisible">
              Toggle
            </label>
            <div className="flex items-center gap-3 py-2">
              ...
              >
                <span
                  className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow transition-transform duration-200 ${showCrashed ? "translate-x-4" : "translate-x-0.5"}`}
                />
              </button>
            ...
            {showColPicker && (
              <div className="absolute right-0 top-full mt-1 w-52 bg-white border border-gray-200 rounded-xl shadow-lg z-20 py-2 max-h-72 overflow-y-auto">
                {ALL_COLUMNS.map((col) => (
                  <label
                    key={col.key}
                    className="flex items-center gap-2.5 px-3 py-1.5 hover:bg-gray-50 cursor-pointer text-xs text-gray-700"
                  >
                    <input
                      type="checkbox"
                      defaultChecked
            ...
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50/50">
                ...
                {[
                  ...
                  {
                    key: "affiliateComms" as keyof Sale,
                    label: "AFFILIATE COMMS",
                  },
                  ...
                  >
                    <span className="flex items-center gap-1">
                      {col.label}
                      <ArrowUpDown
                        className={`w-3 h-3 transition-colors ${sortKey === col.key ? "text-orange-500" : "text-gray-300 group-hover:text-gray-400"}`}
                      />
                    </span>
                  </th>
                ))}
            ...
            <tbody>
              {paged.map((sale, i) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 text-orange-500 font-medium whitespace-nowrap">
                    {sale.developer}
                  </td>
