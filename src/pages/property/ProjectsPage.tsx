            ...
            >
              <div className="bg-gray-900/95 backdrop-blur-sm text-white text-[10px] font-medium px-2.5 py-1.5 rounded-lg whitespace-nowrap shadow-xl border border-white/10">
                ...
                <p className="text-gray-300 text-[9px] mt-0.5">
                  {p.suburb}, {p.state} · ${p.priceMin.toLocaleString()}
                </p>
              </div>
...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      {/* Thumbnail */}
      <div
        className={`relative w-[128px] shrink-0 bg-gradient-to-br ${p.imgGrad}`}
      >
        {/* Action icons */}
        ...
        <div className="absolute bottom-2 left-2">
          <div
            className={`w-1.5 h-1.5 rounded-full ${TYPE_DOT[p.type] ?? "bg-gray-400"}`}
          />
        </div>
      </div>
...
function Toggle({
  ...
  return (
    ...
    >
      <div
        className={`relative inline-flex h-4.5 w-8 items-center rounded-full transition-colors duration-200 ${enabled ? "bg-orange-500" : "bg-gray-200"}`}
  ...
  return (
    <div className="h-full min-h-0 w-full">
              ...
              <div className="flex flex-col gap-1">
                ...
                {radiusEnabled && (
                  <input
                    ...
                    className="w-full h-2 accent-orange-500 cursor-pointer rounded-full mt-1"
      ...
      <div className="flex-1 min-h-0">
        ...
        {/* Left: list panel */}
        <div className="xl:col-span-5 shrink-0 flex flex-col bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
          {/* Toolbar */}
