...
const MOCK_DATA: EnquiryRow[] = [
  ...
  { id: '8',  agentName: 'Craig Cameron',               clientName: 'Sabitha Andrews and Santhosh Chandy Sabitha Andrews and Santhosh Chandy', clientContact: '0422603076', createDate: '15 Apr 2026 03:22 pm', updateDate: '15 Apr 2026 03:22 pm', status: 'Pending' },
  { id: '9',  agentName: 'Craig Cameron',               clientName: 'Sabitha Andrews and Santhosh Chandy Sabitha Andrews and Santhosh Chandy', clientContact: '0422603076', createDate: '14 Apr 2026 07:46 pm', updateDate: '14 Apr 2026 07:46 pm', status: 'Pending' },
  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <button className="flex items-center gap-1.5 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium rounded-lg transition-colors">
