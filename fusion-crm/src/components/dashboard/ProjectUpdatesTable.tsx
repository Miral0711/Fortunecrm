  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
        <div>
          <h3 className="text-sm font-semibold text-gray-800">Project Updates</h3>
          <p className="text-xs text-gray-400 mt-0.5">Lot creation & update activity</p>
        </div>
      ...
      <DataTable columns={columns} data={projectUpdates} keyField="id" />
    </div>
  )
}
